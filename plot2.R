## plot2.R
## reads data and creates plot #2 for project 1. See followjng link for project details
...
dev.copy(png, file = "C:\\andyXP\\learnings\\coursera_ds_exploratory\\project_1\\plot2.png")
dev.off()
